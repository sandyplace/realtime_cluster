...
function adapter(uri, opts){
  ...
  function Redis(nsp){
    ...
    var self = this;
    sub.psubscribe(prefix + '#*', function(err, res){
  ...
  Redis.prototype.onmessage = function(pattern, redisChannel, msg) {
    var pieces = redisChannel.split('#');
    if (uid === pieces.pop()) return;
